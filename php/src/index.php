...
<html> 
    <head> 
        ...
        <link rel="stylesheet" type="text/css" href="https://objectstorage.ap-osaka-1.oraclecloud.com/n/ax9vujnwdmvy/b/Ujian_Tengah_Semester/o/style.css"> 
    </head> 
    <body> 
        <div id="container"> 
            <div id="header"> 
                <div id="logo-perpustakaan-container"> 
                    <image id="logo-perpustakaan" src="https://objectstorage.ap-osaka-1.oraclecloud.com/n/ax9vujnwdmvy/b/Ujian_Tengah_Semester/o/images%2Flogo-perpustakaan3.png" border=0 style="border:0; text-decoration:none; outline:none"> 
                </div> 
