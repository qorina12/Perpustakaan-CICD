...
<div id="content"> 
    <table id="tabel-input"> 
        <tr> 
            ...
            <td class="isian-formulir"><img src="https://objectstorage.ap-osaka-1.oraclecloud.com/n/ax9vujnwdmvy/b/Ujian_Tengah_Semester/o/images%2F/<?php echo $foto; ?>" width="70px" height="75px"></td> 
        </tr> 
        <tr>
